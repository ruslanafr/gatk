            ...
            for ( final VariantContext vc : dataSource ) {
                ...
                switch ( svType ) {
                    ...
                    case CNV:
                        ...
                        breakpoints.put(new SVInterval(contigID,end-padding, end+padding), eventName);
                        break;
                    case INS:
                    case DUP:
                        final int extraPadding = padding + vc.getAttributeAsInt(GATKSVVCFConstants.SVLEN, 0);
                        breakpoints.put(new SVInterval(contigID,start-extraPadding, start+extraPadding), eventName);
                        break;
                    case BND:
                        breakpoints.put(new SVInterval(contigID,start-padding, start+padding), eventName);
                        break;
