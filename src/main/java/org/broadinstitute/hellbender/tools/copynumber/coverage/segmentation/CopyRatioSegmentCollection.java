...
public final class CopyRatioSegmentCollection extends SampleLocatableCollection<CopyRatioSegment> {
    ...
    public CopyRatioSegmentCollection(final SampleMetadata sampleMetadata,
        ...
        super(sampleMetadata, copyRatioSegments, CopyRatioSegmentTableColumn.COLUMNS, COPY_RATIO_SEGMENT_DATA_LINE_TO_RECORD_FUNCTION, COPY_RATIO_SEGMENT_RECORD_AND_DATA_LINE_BI_CONSUMER);
    }
}