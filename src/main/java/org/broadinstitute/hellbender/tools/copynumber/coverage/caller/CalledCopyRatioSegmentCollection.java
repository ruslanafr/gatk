...
public final class CalledCopyRatioSegmentCollection extends SampleLocatableCollection<CalledCopyRatioSegment> {
    ...
    public CalledCopyRatioSegmentCollection(final SampleMetadata sampleMetadata,
        ...
        super(sampleMetadata, calledCopyRatioSegments, CalledCopyRatioSegmentTableColumn.COLUMNS, CALLED_COPY_RATIO_SEGMENT_DATA_LINE_TO_RECORD_FUNCTION, CALLED_COPY_RATIO_SEGMENT_RECORD_AND_DATA_LINE_BI_CONSUMER);
    }
}