...
public final class ModelSegments extends CommandLineProgram {
    ...
    public static final String MULTIDIMENSIONAL_SEGMENTS_FILE_SUFFIX = ".craf" + SEGMENTS_FILE_SUFFIX;
    ...
    private double smoothingCredibleIntervalThresholdAlleleFraction = 1.;
    ...
    protected Object doWork() {
        ...
        writeSegments(multidimensionalSegments, MULTIDIMENSIONAL_SEGMENTS_FILE_SUFFIX);
