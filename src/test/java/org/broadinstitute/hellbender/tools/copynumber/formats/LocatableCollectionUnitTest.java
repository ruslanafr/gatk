...
public final class LocatableCollectionUnitTest extends BaseTest {
    ...
    public void testReadMissingColumn() {
        new SimpleLocatableCollection(SIMPLE_LOCATABLE_COLLECTION_MISSING_COLUMN_FILE);
    }
    ...
    public void testIntervalsWithDuplicates() {
        ...
        new SimpleLocatableCollection("sampleName", intervalsWithDuplicates);
    }
    ...
    public void testIntervalsWithOverlaps() {
        final List<SimpleLocatable> intervalsWithOverlaps = Arrays.asList(
                ...
                new SimpleLocatable(new SimpleInterval("2", 1, 1), 1));
        new SimpleLocatableCollection("sampleName", intervalsWithOverlaps);
    }
