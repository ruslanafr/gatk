...
public class DataProviderForPik3caMnpFullData {
    ...
    public static List<Object[]> providePik3caInDelData2() {
        ...
        return Arrays.asList(
                //TODO: Fix COORDINATES AND ALLELES!
                ...
                new Object[] { "PIK3CA", 3, 178916621, 178916622, GencodeFuncotation.VariantClassification.FRAME_SHIFT_INS, GencodeFuncotation.VariantType.INS, "C",       "CTATT",      "g.chr3:178916621_178916622insTATT",      "+", "c.8_9insTATT",       "c.(7-12)ccacgafs",          "p.R4fs" },
