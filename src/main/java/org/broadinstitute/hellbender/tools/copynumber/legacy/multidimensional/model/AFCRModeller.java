 ...
 */
public final class AFCRModeller {
    ...
    public static final Logger logger = LogManager.getLogger(AFCRModeller.class);
     ...
     */
    public AFCRModeller(final SegmentedGenome segmentedGenome,
     ...
     * @param ctx                       JavaSparkContext, used for kernel density estimation in {@link PosteriorSummary}
     */
    public AFCRModeller(final SegmentedGenome segmentedGenome, final AllelicPanelOfNormals allelicPoN,
                        final int numSamplesCopyRatio, final int numBurnInCopyRatio,
                        final int numSamplesAlleleFraction, final int numBurnInAlleleFraction,
                        final JavaSparkContext ctx) {
    ...
    /**
     * Return the state of the model fit, which we trust is accurately recorded by {@link AFCRModeller#isModelFit}.
